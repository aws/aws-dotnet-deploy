...
namespace AWS.DeploymentDockerEngine
{
    ...
    {
        private const string DockerFileConfig = "AWS.DeploymentDockerEngine.Properties.DockerFileConfig.json";
        private const string DockerfileTemplate = "AWS.DeploymentDockerEngine.Templates.Dockerfile.template";
