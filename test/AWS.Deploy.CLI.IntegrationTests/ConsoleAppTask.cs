...
namespace AWS.Deploy.CLI.IntegrationTests
{
    ...
    public class ConsoleAppTaskTest
    {
        ...
        {
            var projectPath = Path.Combine("testapps", "ConsoleAppTask", "ConsoleAppTask.csproj");
            ...
            var stackName = $"ConsoleAppTask{Guid.NewGuid().ToString().Split('-').Last()}";
