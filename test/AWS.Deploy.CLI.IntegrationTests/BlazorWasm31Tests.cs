...
namespace AWS.Deploy.CLI.IntegrationTests
{
    ...
    public class BlazorWasm31Tests
    {
        ...
        {
            var projectPath = Path.Combine("testapps", "BlazorWasm31", "BlazorWasm31.csproj");
            ...
            var stackName = $"BlazorWasm31{Guid.NewGuid().ToString().Split('-').Last()}";
