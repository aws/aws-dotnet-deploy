...
namespace AWS.Deploy.CLI.UnitTests
{
    public class ServerModeTests
    {
        ...
        public async Task RecipeController_GetRecipe_EmptyId(string recipeId)
        {
            ...
            var recipeHandler = new RecipeHandler(deploymentManifestEngine, consoleOrchestratorLogger, directoryManager, optionSettingHandler);
        ...
        public async Task RecipeController_GetRecipe_WithProjectPath()
        {
            ...
            var recipeHandler = new RecipeHandler(deploymentManifestEngine.Object, orchestratorInteractiveService, directoryManager, optionSettingHandler);
